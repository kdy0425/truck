    ...
    $.fn.jqGrid = function( pin ) {
        ...
        return this.each( function() {
            ...
            addMulti = function(rowid,pos,irow,checked){
                var	v = "<label for=\"#jqg_"+ts.p.id+"_"+rowid+"\" class=\"checkbox single\"><input role=\"checkbox\" type=\"checkbox\""+" id=\"jqg_"+ts.p.id+"_"+rowid+"\" class=\"cbox\" name=\"jqg_"+ts.p.id+"_"+rowid+"\"" + (checked ? "checked=\"checked\"" : "")+"/><span class=\"ck_icon\"></span></label>",
            ...
            if(this.p.multiselect) {
                this.p.colNames.unshift("<label class='checkbox single'><input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/><span class='ck_icon'></span></label>");
